...
\end{lstlisting}
\begin{lstlisting}[caption=Command untuk cara menambah project baru,
	label={lst:newproject}]
‘phalcon create-project <project-name>’
\end{lstlisting}
 \begin{itemize}
...
\begin{references}{3.}
\bibitem{prokofyeva2017analysis}Prokofyeva, Natalya and Boltunova, Victoria,
